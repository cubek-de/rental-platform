...
const UserDashboard = () => {
  ...
  const handleRemoveFavorite = async (vehicleId) => {
    try {
      ...
      toast.success("Fahrzeug aus Favoriten entfernt");
    } catch (error) {
          ...
          <div>
            ...
            {favoritesLoading ? (
              ...
              <div className="bg-white rounded-xl shadow-lg border p-8 text-center">
                <HiHeart className="w-16 h-16 mx-auto text-gray-300 mb-4" />
                <p className="text-gray-500 text-lg">
                  Sie haben noch keine Favoriten hinzugefügt.
                </p>
                <p className="text-gray-400 mt-2">
                  Durchsuchen Sie unsere Fahrzeuge und fügen Sie Ihre Favoriten hinzu!
                </p>
                <Link
                  to="/vehicles"
                  className="inline-block mt-6 px-6 py-3 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition-colors"
                >
                  Fahrzeuge entdecken
                </Link>
              </div>
                    ...
                    <div className="relative h-48">
                      <img
                        src={
                          ...
                          "https://via.placeholder.com/400x300?text=Fahrzeug"
                        }
                        alt={vehicle.name}
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center text-gray-600 mb-3">
                        ...
                        <span className="text-sm">
                          {vehicle.location?.city || "Standort nicht verfügbar"}
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                        <div>
