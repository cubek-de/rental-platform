...
const AgentProfilePage = () => {
  ...
  const handleSpecializationChange = (specialization) => {
    const currentSpecializations =
      profileData["agentProfile.specializations"] || [];
    ...
    handleInputChange("agentProfile.specializations", newSpecializations);
  };
  ...
  const tabs = [
    ...
    { id: "business", label: "Geschäftsdaten", icon: FiBriefcase },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Verwalten Sie Ihre Agent-Informationen und Geschäftsdaten
          </p>
        </div>

        {/* Profile Header Card */}
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
          <div className="bg-gradient-to-r from-orange-600 via-red-600 to-orange-800 px-8 py-12 text-white relative">
            {/* Background Pattern */}
            ...
            <div className="relative flex items-center justify-between">
              <div className="flex items-center space-x-6">
                ...
                <div className="relative">
                  <div className="w-28 h-28 bg-white/20 rounded-full flex items-center justify-center overflow-hidden">
                    {user?.profile?.avatar ? (
                      ...
                      <FiBriefcase className="w-14 h-14 text-white" />
                    )}
                  </div>
                ...
                <div>
                  ...
                  <p className="text-orange-100 text-lg">Fahrzeug-Agent</p>
                  {user?.agentProfile?.company && (
                    <p className="text-orange-200">
                      bei {user.agentProfile.company}
                    </p>
                  )}
                  <div className="flex items-center gap-4 mt-3">
                    ...
                    <span className="bg-orange-500/50 text-white px-3 py-1 rounded-full text-sm">
              ...
              {stats && (
                <div className="hidden lg:flex space-x-6">
                  <div className="text-center">
                    ...
                    <div className="text-orange-200 text-sm">Fahrzeuge</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold">
                      €{stats.totalCommissions || 0}
                    </div>
                    <div className="text-orange-200 text-sm">Provisionen</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold">
                      {stats.totalClients || 0}
                    </div>
                    <div className="text-orange-200 text-sm">Kunden</div>
                  </div>
                </div>
              )}
            </div>
              ...
              <div className="flex justify-between items-center">
                ...
                {!isEditing ? (
                  <button
                    ...
                    className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-lg transition-all duration-300 flex items-center gap-2 shadow-lg hover:shadow-xl"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    ...
                    <div className="px-4 py-3 bg-gray-50 rounded-lg text-gray-800 font-medium">
                      {profileData["agentProfile.company"] || "Nicht angegeben"}
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    <input
                      ...
                      max="100"
                      step="0.1"
                      value={profileData["agentProfile.commissionRate"]}
                      onChange={(e) =>
                        handleInputChange(
                    ...
                    <div className="px-4 py-3 bg-gray-50 rounded-lg text-gray-800 font-medium">
                      {profileData["agentProfile.commissionRate"]}%
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="border-t pt-8">
                ...
                {isEditing ? (
                  ...
                  <div className="flex flex-wrap gap-2">
                    {profileData["agentProfile.specializations"].length > 0 ? (
                      profileData["agentProfile.specializations"].map(
                        (spec) => (
                          <span
                            key={spec}
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-6 border border-orange-200">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="mt-4 bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-lg transition-all duration-300 flex items-center gap-2 disabled:opacity-50"
                >
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-xl p-6 border border-red-200">
                ...
                <button
                  onClick={handleSave}
                  disabled={isLoading}
                  className="mt-6 bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg transition-all duration-300 flex items-center gap-2 disabled:opacity-50"
                >
                  <FiSave className="w-4 h-4" />
                  {isLoading
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-xl p-6 shadow-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-blue-100">Gesamte Kunden</p>
                      <p className="text-3xl font-bold">
                        {stats?.totalClients || 0}
                      </p>
                    </div>
                ...
                <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 text-white rounded-xl p-6 shadow-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-yellow-100">Durchschn. Bewertung</p>
                      <p className="text-3xl font-bold">
              ...
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg">
                    <span className="text-gray-700">Kundenzufriedenheit</span>
                  ...
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg">
                    <span className="text-gray-700">Aktive Fahrzeuge</span>
                    <span className="text-gray-600">
                      {stats?.activeVehicles || 0} von{" "}
                      {stats?.managedVehicles || 0}
                    </span>
                  </div>
                </div>
