...
const AgentDashboardPage = () => {
  ...
  const fetchDashboardData = useCallback(async () => {
    try {
      ...
      const vehiclesPromise = api.get("/api/vehicles").catch((err) => {
      ...
      setStats({
        ...
        pendingApprovals: vehiclesData.filter(
  ...
  const handleCreateVehicle = async (e) => {
    ...
    try {
      ...
      const vehicleData = {
        ...
        category:
          newVehicle.type === "wohnmobil"
            ? "Wohnmobil"
            : newVehicle.type === "kastenwagen"
            ? "Kastenwagen"
            : "Wohnwagen",
        ...
        technicalData: {
          ...
          fuel: newVehicle.fuel || "diesel",
          transmission: newVehicle.transmission || "manual",
        },
        capacity: {
          seats: parseInt(newVehicle.capacity) || 4,
          sleepingPlaces: parseInt(newVehicle.capacity) || 4,
        },
        pricing: {
          basePrice: {
      ...
      case "vehicles":
        return (
          <div className="text-center py-12">
            <p className="text-gray-600">Fahrzeuge Verwaltung kommt bald...</p>
          </div>
        );
      case "bookings":
        return (
      ...
      >
        ...
        <Modal.Body>
          <form onSubmit={handleCreateVehicle} className="space-y-4">
            <div>
              <Label htmlFor="vehicleName" value="Fahrzeugname" />
              <TextInput
                id="vehicleName"
            ...
            <div>
              <Label htmlFor="vehicleType" value="Fahrzeugtyp" />
              <Select
                id="vehicleType"
            ...
            <div>
              <Label htmlFor="pricePerDay" value="Preis pro Tag (€)" />
              <TextInput
                id="pricePerDay"
                type="number"
            ...
            <div>
              <Label htmlFor="capacity" value="Kapazität (Personen)" />
              <TextInput
                id="capacity"
                type="number"
            ...
            <div className="flex justify-end space-x-3">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="bg-gradient-to-r from-emerald-500 to-teal-600 border-0"
              >
