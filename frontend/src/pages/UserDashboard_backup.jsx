    ...
    return (
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-8 border border-gray-200">
          <div className="bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-600 px-8 py-8 text-white relative">
            <div className="relative flex items-center justify-between">
              <div className="flex items-center space-x-6">
                ...
                <div>
                  ...
                  <p className="text-emerald-100 text-lg">Kunde</p>
              ...
              {stats && (
                <div className="hidden lg:flex space-x-4">
                  <div className="text-center">
                    ...
                    <div className="text-emerald-200 text-xs">Buchungen</div>
                  </div>
                  <div className="text-center">
                    <div className="text-xl font-bold">
                      {stats.activeBookings || 0}
                    </div>
                    <div className="text-emerald-200 text-xs">Aktiv</div>
                  </div>
                  <div className="text-center">
                    <div className="text-xl font-bold">
              ...
              <div className="flex justify-between items-center">
                ...
                {!isEditing ? (
                  <button
                    ...
                    className="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg transition-all duration-300 flex items-center gap-2 shadow-lg hover:shadow-xl"
                  >
        ...
        return (
          <div>
            ...
            <div className="bg-white rounded-xl shadow-lg border p-8">
              <div className="text-center">
                <HiHeart className="mx-auto h-12 w-12 text-gray-400 mb-4" />
                <p className="text-gray-500">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-white/80 text-lg">
                    Verwalten Sie Ihre Buchungen und entdecken Sie neue Fahrzeuge
                  </p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:scale-105">
                  ...
                  <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div 
                      ...
                      style={{ 
                        width: `${vehicleStats.totalBookings > 0 ? (vehicleStats.activeBookings / vehicleStats.totalBookings) * 100 : 0}%` 
                      }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:scale-105">
                  ...
                  <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div 
                      ...
                      style={{ 
                        width: `${vehicleStats.totalBookings > 0 ? (vehicleStats.completedBookings / vehicleStats.totalBookings) * 100 : 0}%` 
                      }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:scale-105">
                  ...
                  <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div 
                      ...
                      style={{ 
                        width: `${vehicleStats.totalBookings > 0 ? (vehicleStats.pendingBookings / vehicleStats.totalBookings) * 100 : 0}%` 
                      }}
                    ></div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 group">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-gray-900">Fahrzeuge suchen</h3>
                    <p className="text-gray-500 text-sm">Neue Fahrzeuge entdecken</p>
                  </div>
                </div>
                <button 
              ...
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 group">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-gray-900">Buchungen verwalten</h3>
                    <p className="text-gray-500 text-sm">Alle Buchungen anzeigen</p>
                  </div>
                </div>
                <button 
              ...
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 group">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-gray-900">Meine Favoriten</h3>
                    <p className="text-gray-500 text-sm">Gespeicherte Fahrzeuge</p>
                  </div>
                </div>
                <button 
              ...
              <div className="bg-gradient-to-r from-emerald-50 to-teal-50 px-8 py-6 border-b border-gray-100">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">Ihre letzten Fahrzeugbuchungen im Überblick</p>
                  </div>
                  <button
                    onClick={() => setActiveSection("bookings")}
              ...
              <div className="p-8">
                {isLoading ? (
                  <div className="flex items-center justify-center py-12">
                    ...
                    <p className="ml-4 text-gray-500 font-medium">Lade Buchungen...</p>
                  </div>
                      ...
                      >
                        <div className="flex justify-between items-start">
                          ...
                          <div className="flex flex-col items-end space-y-2">
                            ...
                            <p className="text-xs text-gray-400">Buchung #{index + 1}</p>
                          </div>
                        </div>
                      </div>
                    ))}
